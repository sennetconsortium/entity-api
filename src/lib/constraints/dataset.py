...
def build_dataset_search_constraints(entity):
    ...
    ancestor2 = build_search_constraint_unit('sample_category.keyword', SpecimenCategories.BLOCK.lower())
    ancestor3 = build_search_constraint_unit('sample_category.keyword', SpecimenCategories.SECTION.lower())
    ancestor4 = build_search_constraint_unit('sample_category.keyword', SpecimenCategories.SUSPENSION.lower())
